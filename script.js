const SITE_URL = 'https://misshome.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Miss Home — Sonic Remedy | Soozhee',
        text: 'Miss Home by Soozhee. Sonic Remedy : Audiosensory Resonance | Alien Frequencies.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
